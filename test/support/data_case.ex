defmodule DataCase do
  ...
  @doc "User with stateless tokens factory (store_all_tokens?: false)"
  @spec build_user_with_stateless_tokens(keyword) :: ExampleStateless.User.t() | no_return
  def build_user_with_stateless_tokens(attrs \\ []) do
    password = password()
