...
defmodule Example.UserWithExcludedStrategies do
  @moduledoc false
  use Ash.Resource,
  ...
  postgres do
    table "users_with_excluded_strategies"
    repo(Example.Repo)
  end
  ...
  authentication do
    ...
    add_ons do
      audit_log do
        ...
        # Exclude the audit log add-on itself from logging
        exclude_strategies([:audit_log])
      end
    end
