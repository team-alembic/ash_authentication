...
## [v3.0.5](https://github.com/team-alembic/ash_authentication/compare/v3.0.4...v3.0.5) (2022-12-08)
...
* use `Code.ensure_compiled!` which "demands" that the comâ¦ (#75)

* use `Code.ensure_compiled!` which "demands" that the compiler wait for X module
