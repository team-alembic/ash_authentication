  ...
  def dsl do
    %Spark.Dsl.Entity{
      ...
      schema: [
        ...
        identity_field: [
          type: :atom,
          doc: "The field for the human-readable user identity",
          required: true
        ],
        storage_field: [
          type: :atom,
        ...
        setup_action_name: [
          type: :atom,
          doc: "The name to use for the TOTP setup action. Defaults to `setup_<strategy_name>`.",
          required: false,
          default: :setup_two_factor_totp
        ],
        verify_action_name: [
          type: :atom,
          doc:
          ...
          required: false,
          default: :verify_two_factor_totp
        ],
        issuer: [
          type: :string,
