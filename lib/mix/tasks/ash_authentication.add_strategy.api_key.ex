...
if Code.ensure_loaded?(Igniter) do
  defmodule Mix.Tasks.AshAuthentication.AddStrategy.ApiKey do
    use Igniter.Mix.Task

    @example "mix ash_authentication.add_strategy.api_key"

    @shortdoc "Adds API key authentication to your user resource"
  ...
  defmodule Mix.Tasks.AshAuthentication.AddStrategy.ApiKey do
    ...
    def run(_argv) do
      Mix.shell().error("""
      The task 'ash_authentication.add_strategy.api_key' requires igniter to be run.
