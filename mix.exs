  ...
  defp docs do
    [
      ...
      extras: [
        ...
        "documentation/how-to/auth0.md",
        "documentation/how-to/github.md",
        "documentation/how-to/google.md",
        "documentation/how-to/magic-links.md",
        "documentation/how-to/confirmation.md",
