  ...
  defp docs do
    [
      ...
      extras: [
        ...
        {"documentation/dsls/DSL-AshAuthentication.AddOn.TwoFactorTotp.md",
         search_data: Spark.Docs.search_data_for(AshAuthentication.AddOn.TwoFactorTotp)},
      ...
      groups_for_modules: [
        ...
        Strategies: [
          ...
          AshAuthentication.AddOn.TwoFactorTotp,
