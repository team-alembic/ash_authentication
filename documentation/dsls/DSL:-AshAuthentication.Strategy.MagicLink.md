...
| [`registration_enabled?`](#authentication-strategies-magic_link-registration_enabled?){: #authentication-strategies-magic_link-registration_enabled? } | `boolean` | `false` | If you want new users to be able to register using this strategy, set this to true. This means that requesting a magic link an *upsert* action instead of a read action. |
