...
| [`revoke_all_tokens_action_name`](#token-revocation-revoke_all_tokens_action_name){: #token-revocation-revoke_all_tokens_action_name } | `atom` | `:revoke_all_tokens` | The name of the action used to revoke all tokens for a given subject. |
