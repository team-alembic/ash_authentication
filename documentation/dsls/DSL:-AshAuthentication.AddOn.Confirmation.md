...
| [`ignore_actions`](#authentication-add_ons-confirmation-ignore_actions){: #authentication-add_ons-confirmation-ignore_actions } | `list(atom)` |  | A list of actions that should be ignored by this confirmation strategy. The confirmation sender will not be invoked, and the confirmed_at field will not be altered. |
